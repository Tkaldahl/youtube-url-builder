...
import { PlaylistSearchResultComponent } from "../playlist-search-result/playlist-search-result.component";
...
@Component({
  ...
  export class PlaylistSearchBarComponent {
    ...
    searchPlaylists(): void {
        this.playlists = this.staticPlaylistResults as PlaylistDoc[]

        // TODO: Implement backend search instead of simulated results
